...
public class IsolationTest {
    ...
    public void createAccount() {
        final Account generatedAccount = RandomGeneratorUtil.generateRandomUnassignedAccount();
        generatedAccount.setCustomerId(customerService.getRandomCustomerId());
        accountService.saveAccount(generatedAccount);
    }
